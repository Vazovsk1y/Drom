        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldDateTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "PasswordHash", "PhoneNumber", "RegistrationDateTime", "Role", "Username" },
                values: new object[] { new Guid("3ee9159b-2673-4a0c-8a94-fc6384e64565"), "$2a$11$AqjCOw8ml9R9dn8v2TS4vetA8rKBdeZk2MJe8tpE29bs1CBIAk8RG", "+7 999 999 9999", new DateTimeOffset(new DateTime(2025, 6, 5, 18, 17, 12, 101, DateTimeKind.Unspecified).AddTicks(1119), new TimeSpan(0, 0, 0, 0, 0)), "Admin", "Admin" });
